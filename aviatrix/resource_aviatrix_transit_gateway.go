...
func resourceAviatrixTransitGatewayRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.Set("enable_hybrid_connection", (gw.CloudType == goaviatrix.AWS || gw.CloudType == goaviatrix.AWSGOV) && gw.EnableHybridConnection)
	...
	d.Set("enable_bgp_over_lan", gw.CloudType == goaviatrix.AZURE && gw.EnableBgpOverLan)
	...
	if gw.EnableTransitFirenet && gw.CloudType == goaviatrix.GCP {
